                ...
                <div className='col-lg-6 col-sm-12'>
                    <div className='row'>
                        ...
                        <div className='col-lg-12 col-sm-12 form-group pt-2'>
                            <label className='mb-2' htmlFor="taskdate">Task Date</label>
                        ...
                        <div className='col-lg-12 col-sm-12 form-group pt-2'>
                            <label className='mb-2' htmlFor="description">Task Description</label>
                            <textarea
                        ...
                        <div className='col-lg-8 col-sm-12 pt-2 mt-2 form-group'>
                            <button type="submit" className='btn btn-style-one form-control' >{formType === 'add' ? "Save Task" : "Update Task"} </button>
